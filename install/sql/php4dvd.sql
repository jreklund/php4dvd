...
CREATE TABLE `movies` (
  ...
  `nameorder` VARCHAR(255) COLLATE __COLLATE__ NOT NULL,
  `aka` text COLLATE __COLLATE__ NOT NULL,
  `year` smallint(4) UNSIGNED NOT NULL,
  `duration` smallint(4) UNSIGNED NOT NULL,
  `rating` double NOT NULL,
  `votes` int(8) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `mpaa` text COLLATE __COLLATE__ NOT NULL,
  `pg` tinyint(2) UNSIGNED NOT NULL DEFAULT '21',
  PRIMARY KEY (`id`),
  KEY `loaned` (`loaned`),
  KEY `format` (`format`)
) ENGINE=InnoDB DEFAULT CHARSET=__CHARACTER__ COLLATE=__COLLATE__;
...
INSERT INTO `users` (`id`, `email`, `username`, `password`, `permission`) VALUES
