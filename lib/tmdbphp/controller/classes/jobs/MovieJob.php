...
class MovieJob {
     ...
     * 	Construct Class
     *
     * 	@param array $data An array with the data of a TMDBMovie job
     */
    ...
    /**
     *  Get the TMDBMovie's original title
     *
     *  @return string
     */
    ...
    /**
     *  Get the TMDBMovie's release date
     *
     *  @return string
     */
    ...
    /**
     *  Get the JSON representation of the TMDBMovie job
     *
     *  @return string
     */
