            ...
            <div class="container">
                ...
                <?php $zones = [
                    'movies' => [
                        'name' => 'Movies',
                        'examples' => [
                            'searchMovie' => 'Search TMDBMovie',
                            'infoMovie' => 'Full TMDBMovie Info',
                            'featuredMovies' => 'Featured Movies',
                            'searchMovieByGenre' => 'Search TMDBMovie by Genre',
                            '1' => 'hr',
                            ...
                            'findMovie' => 'Find TMDBMovie by external ID',
                        ],
                    ],
                    'tvshows' => [
                        'name' => 'TV Shows',
                    ...
                    'genres' => [
                        'name' => 'Genre',
                        'examples' => [
                            'movieGenres' => 'Get a List of TMDBMovie Genres',
