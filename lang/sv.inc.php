...
define("nameorder asc",								"Namn (A-Z)");
define("nameorder desc",							"Namn (Z-A)");
define("year asc",									"År (0-9)");
define("year desc",									"År (9-0)");
define("rating asc",								"Betyg (0-9)");
define("rating desc",								"Betyg (9-0)");
define("votes asc",								    "Röster (0-9)");
define("votes desc",								"Röster (9-0)");
...
define("PARENTAL_GUIDANCE",							"Åldersgräns");
define("PARENTAL_GUIDANCE_AGE",						"år");
