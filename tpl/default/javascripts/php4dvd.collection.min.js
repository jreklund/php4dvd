...
function search(){if(!ajaxSearchLock){ajaxSearchLock=!0;var e="./#!/",o="./?go=movies",t=$("#q").val();t?(o+="&q="+encodeURIComponent(t),e+="search/"+encodeURIComponent(t)+"/",Cookies.set("search",t,{expires:14})):Cookies.remove("search");var n=$("#category").val();n?(o+="&c="+encodeURIComponent(n),e+="category/"+encodeURIComponent(n)+"/",Cookies.set("category",n,{expires:14})):Cookies.remove("category");var a=$("#format").val();a?(o+="&f="+encodeURIComponent(a),e+="format/"+encodeURIComponent(a)+"/",Cookies.set("format",a,{expires:14})):Cookies.remove("format");var s=$("#sort").val();s?(o+="&s="+encodeURIComponent(s),e+="sort/"+encodeURIComponent(s)+"/",Cookies.set("sort",s,{expires:14})):Cookies.remove("sort");var r=$("#pg").slider("getValue").toString();r?(o+="&pg="+encodeURIComponent(r),Cookies.set("pg",r,{expires:14})):Cookies.remove("pg");var i=$("#l").val();i?(o+="&l="+encodeURIComponent(i),Cookies.set("layout",i,{expires:14})):Cookies.set("layout",0);var v=$("#movie").val();v?(o+="&movie="+encodeURIComponent(v),Cookies.set("movie",v,{expires:14})):Cookies.set("movie",0);var l=$("#tv").val();l?(o+="&tv="+encodeURIComponent(l),Cookies.set("tv",l,{expires:14})):Cookies.set("tv",0);var c=$("#own").val();c?(o+="&own="+encodeURIComponent(c),Cookies.set("own",c,{expires:14})):Cookies.set("own",-1);var p=$("#seen").val();p?(o+="&seen="+encodeURIComponent(p),Cookies.set("seen",p,{expires:14})):Cookies.set("seen",-1);var m=$("#favourite").val();m?(o+="&favourite="+encodeURIComponent(m),Cookies.set("favourite",m,{expires:14})):Cookies.set("favourite",-1);var C=$("#p").val();C&&C>0?(o+="&p="+encodeURIComponent(C),e+="page/"+encodeURIComponent(C)+"/",Cookies.set("page",C,{expires:14})):Cookies.set("page",0);var d=$("#n").val();d&&d>0?(o+="&n="+encodeURIComponent(d),e+="results/"+encodeURIComponent(d)+"/",Cookies.set("results",d,{expires:14})):Cookies.remove("results"),$("#results").hide(),$("#loading").delay(600).show(0),$.ajax({url:o,dataType:"html",success:function(e){$("#results").html(e).fadeIn(600),$("#loading").hide(0)},complete:function(){window.location.href=e,ajaxSearchLock=!1}})}}function resetSearch(){var e=$("#pg");$("#q").val(""),$("#p").val(0),e.slider("setValue",[e.data("slider-min"),e.data("slider-max")]),$("#movie").val(0),$("#tv").val(0),$("#own").val(-1),$("#seen").val(-1),$("#favourite").val(-1),$("#category").val(""),$("#format").val(""),$("#filter-by").html($("#filter-by-original").html())}function getQueryStringParameters(){var e=new RegExp("#!/(.*?)/?$").exec(window.location.href);if(e&&e.length>0){for(var o=new Array,t=e[1].split("/"),n=0;n<t.length;n++)o[decodeURIComponent(t[n])]=decodeURIComponent(t[++n]);return o}return!1}var ajaxSearchLock=!1,loadingTimer;
